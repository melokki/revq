...
data class SettingsDraft(
    ...
    fun toSettings(): RevqSettings = RevqSettings(
        ...
        customNotificationSoundPath = customNotificationSoundPath,
        sortMode = sortMode,
    ...
    companion object {
        fun from(settings: RevqSettings): SettingsDraft = SettingsDraft(
            ...
            showReviewCountInTray = settings.showReviewCountInTray,
            notifyOnNewReviewAssignments = settings.notifyOnNewReviewAssignments,
